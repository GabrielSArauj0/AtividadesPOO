...
namespace VacinacaoPOO.Entities
{
    public class Funcionario
    {
        ...
        public void CadastrarCidadao(Cidadao cidadao, ICadastroService cadastroService)
        {
            Console.WriteLine($"Cidadão {cidadao.Nome} cadastrado por {Nome}.");
            cadastroService.AdicionarCidadao(cidadao, this);
        }

        public void AgendarVacinacao(IVacinacao cidadao, string dataAgendamento)
        {
        ...
        public void Vacinar(IVacinacao cidadao, ICadastroService cadastroService)
        {
