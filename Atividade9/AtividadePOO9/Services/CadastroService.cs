...
public class CadastroService : ICadastroService
{
    ...
    public Cidadao BuscarCidadaoPorCpfEDataAgendamento(string cpf, DateTime dataAgendamento)
    {
        return cidadaos.Find(c => c.Cpf == cpf && c.DataAgendamento == dataAgendamento);
    }

    public List<Cidadao> Cidadaos => cidadaos;

    public void VacinarCidadao(Cidadao cidadao)
    {
        Console.WriteLine($"Cidadão {cidadao.Nome} foi vacinado.");
    }
}